...
inserted before), and false otherwise. boolean startsWith(String prefix) Returns 
...
Trie.prototype.insert = function(word) {
 ...
 for(let i = 0; i < word.length; i++){
     ...
     if(!cur.children[charCode]) cur.children[charCode] = new Trie();
...
Trie.prototype.search = function(word) {
 ...
 for(let i = 0; i < word.length; i++){
     ...
     if(!cur.children[charCode]) return false;      
     cur = cur.children[charCode];
