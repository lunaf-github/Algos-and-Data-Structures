/** 
 * Vague intervier question:
 * Given an integer array nums and an integer val, remove all occurrences 
 * of val in nums in-place. 
 * 
 * Questions:
 * 1.When an integer is removed from the array, What should be added in its place?
 * 2.Are there more than one integer that will be deleted?
*/
...
// this function has a side affect, it 
// removes elements that are equal to val 
// from an array, and returns the length of
// the new array. 
